...
shows what you are choosing between: across the 77 servers measured, cost spans **1,700×**,
...
*(77 of 96 popular servers measured, each row dated by its own most recent sweep — full table in
