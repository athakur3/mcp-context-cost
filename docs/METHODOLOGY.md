...
the badge — it ranged from 0.20× to 1.92× across the 23 servers in the run, and it reorders the leaderboard:
...
across 23 servers), taking the exact published count wherever a server's capture still
