...
An Anthropic request carries 5,582 of those tokens as tool definitions, and Claude counts those at **9,982**.
...
| | tokens | |
|---|---:|---|
| o200k, full capture | 6,134 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 5,582 | 9.0% of the capture is MCP-only metadata |
| **Claude, same fields** | **9,982** | 1.63× the badge number |
...
|---|---:|---:|---|---|---:|
| 2026-09-03 | 6,134 | 28 | not recorded | docker | — |
| 2026-09-04 | 6,134 | 28 | 0.7.0 | docker | no change |
