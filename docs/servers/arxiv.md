...
| | tokens | |
|---|---:|---|
| o200k, full capture | 3,960 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 3,699 | 6.6% of the capture is MCP-only metadata |
| **Claude, same fields** | **6,622** | 1.67× the badge number |
