...
| | tokens | |
|---|---:|---|
| o200k, full capture | 5,462 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 4,799 | 12.1% of the capture is MCP-only metadata |
| **Claude, same fields** | **8,409** | 1.54× the badge number |
