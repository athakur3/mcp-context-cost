...
| | tokens | |
|---|---:|---|
| o200k, full capture | 25,487 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 8,278 | 67.5% of the capture is MCP-only metadata |
| **Claude, same fields** | **13,762** | 0.54× the badge number |
