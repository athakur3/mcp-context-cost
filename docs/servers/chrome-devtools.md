...
An Anthropic request carries 5,100 of those tokens as tool definitions, and Claude counts those at **9,215**.
...
| | tokens | |
|---|---:|---|
| o200k, full capture | 5,717 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 5,100 | 10.8% of the capture is MCP-only metadata |
| **Claude, same fields** | **9,215** | 1.61× the badge number |
