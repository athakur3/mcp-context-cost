...
| | tokens | |
|---|---:|---|
| o200k, full capture | 632 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 495 | 21.7% of the capture is MCP-only metadata |
| **Claude, same fields** | **1,182** | 1.87× the badge number |
