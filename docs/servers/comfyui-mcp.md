...
| | tokens | |
|---|---:|---|
| o200k, full capture | 50,640 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 50,249 | 0.8% of the capture is MCP-only metadata |
| **Claude, same fields** | **83,957** | 1.66× the badge number |
