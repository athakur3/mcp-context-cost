...
**11,837 tokens** across 26 tools — *moderate* (5–15K). Measured 2026-09-09 under [methodology v1.0](../METHODOLOGY.html).

An Anthropic request carries 11,057 of those tokens as tool definitions, and Claude counts those at **19,306**.
...
| canonical SHA-256 | `93139d61e27fc656cd32c0061d5eccc58be171c4246574ef2a48b7f05c2d33ad` |
| category | community |
...
| **Claude, same fields** | **19,306** | 1.63× the badge number |
