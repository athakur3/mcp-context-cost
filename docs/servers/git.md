...
| | tokens | |
|---|---:|---|
| o200k, full capture | 1,455 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 1,119 | 23.1% of the capture is MCP-only metadata |
| **Claude, same fields** | **2,382** | 1.64× the badge number |
