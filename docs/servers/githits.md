...
| | tokens | |
|---|---:|---|
| o200k, full capture | 12,833 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 12,384 | 3.5% of the capture is MCP-only metadata |
| **Claude, same fields** | **20,689** | 1.61× the badge number |
