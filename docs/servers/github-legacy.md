...
| | tokens | |
|---|---:|---|
| o200k, full capture | 3,548 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 3,548 | 0.0% of the capture is MCP-only metadata |
| **Claude, same fields** | **6,662** | 1.88× the badge number |
...
|---|---:|---:|---|---|---:|
| 2026-08-16 | 3,548 | 26 | not recorded | not recorded | — |
| 2026-08-18 | 3,548 | 26 | not recorded | docker | no change |
| 2026-09-03 | 3,548 | 26 | not recorded | docker | no change |
| 2026-09-04 | 3,548 | 26 | 0.6.2 | docker | no change |
