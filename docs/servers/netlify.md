...
| | tokens | |
|---|---:|---|
| o200k, full capture | 2,831 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 2,678 | 5.4% of the capture is MCP-only metadata |
| **Claude, same fields** | **5,229** | 1.85× the badge number |
...
|---|---:|---:|---|---|---:|
| 2026-08-16 | 2,831 | 9 | not recorded | not recorded | — |
| 2026-08-19 | 2,831 | 9 | not recorded | docker | no change |
| 2026-08-26 | 2,831 | 9 | not recorded | docker | no change |
| 2026-09-03 | 2,831 | 9 | not recorded | docker | no change |
| 2026-09-04 | 2,831 | 9 | 1.15.1 | docker | no change |
