...
| | tokens | |
|---|---:|---|
| o200k, full capture | 2,062 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 2,062 | 0.0% of the capture is MCP-only metadata |
| **Claude, same fields** | **3,861** | 1.87× the badge number |
...
|---|---:|---:|---|---|---:|
| 2026-08-18 | 1,132 | 12 | not recorded | not recorded | — |
| 2026-08-19 | 1,132 | 12 | not recorded | docker | no change |
