...
| | tokens | |
|---|---:|---|
| o200k, full capture | 540 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 540 | 0.0% of the capture is MCP-only metadata |
| **Claude, same fields** | **1,267** | 2.35× the badge number |
...
|---|---:|---:|---|---|---:|
| 2026-08-16 | 540 | 7 | not recorded | not recorded | — |
| 2026-08-19 | 540 | 7 | not recorded | docker | no change |
| 2026-09-02 | 540 | 7 | not recorded | docker | no change |
| 2026-09-04 | 540 | 7 | 0.1.0 | docker | no change |
