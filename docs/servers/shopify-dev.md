...
An Anthropic request carries 6,793 of those tokens as tool definitions, and Claude counts those at **11,831**.
...
| | tokens | |
|---|---:|---|
| o200k, full capture | 6,841 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 6,793 | 0.7% of the capture is MCP-only metadata |
| **Claude, same fields** | **11,831** | 1.73× the badge number |
...
|---|---:|---:|---|---|---:|
| 2026-08-16 | 5,624 | 5 | not recorded | not recorded | — |
| 2026-08-19 | 5,624 | 5 | not recorded | docker | no change |
| 2026-09-03 | 6,841 | 6 | not recorded | docker | +1,217 |
| 2026-09-04 | 6,841 | 6 | 1.15.0 | docker | no change |
