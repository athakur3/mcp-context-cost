...
**681 tokens** across 8 tools — *lean* (< 1K). Measured 2026-09-04 under [methodology v1.0](../METHODOLOGY.html).
...
| | tokens | |
|---|---:|---|
| o200k, full capture | 681 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 681 | 0.0% of the capture is MCP-only metadata |
| **Claude, same fields** | **1,483** | 2.18× the badge number |
...
|---|---:|---:|---|---|---:|
| 2026-08-16 | 681 | 8 | not recorded | not recorded | — |
| 2026-08-18 | 681 | 8 | not recorded | docker | no change |
