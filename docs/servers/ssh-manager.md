...
| | tokens | |
|---|---:|---|
| o200k, full capture | 8,446 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 8,149 | 3.5% of the capture is MCP-only metadata |
| **Claude, same fields** | **14,196** | 1.68× the badge number |
