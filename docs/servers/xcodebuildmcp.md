...
**26,594 tokens** across 24 tools — *heavy* (15–30K). Measured 2026-08-19 under [methodology v1.0](../METHODOLOGY.html).
...
Measured 2026-08-31 against `claude-opus-5` via Anthropic's `count_tokens` (method `tools-delta/v1`).

| | tokens | |
|---|---:|---|
| o200k, full capture | 26,594 | the badge number — every byte `tools/list` returned |
| o200k, Anthropic fields only | 2,676 | 89.9% of the capture is MCP-only metadata |
| **Claude, same fields** | **5,335** | 0.20× the badge number |
...
|---|---:|---:|---|---:|
| 2026-08-18 | 26,594 | 24 | not recorded | — |
| 2026-08-19 | 26,594 | 24 | docker | no change |
