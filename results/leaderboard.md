...
Tokens = o200k_base count of the canonical `tools/list` bytes ([methodology v1.0](../docs/METHODOLOGY.md)). Measured 86/106 candidates; every candidate is listed — failures are findings, not omissions. Server names link to their per-tool breakdown.

The **claude** column is the same tools measured through Anthropic's `count_tokens` on `claude-opus-5` (2026-09-05, method `tools-delta/v1`): the tokens the server's tools add to a request, measured for the top 15. It is not a rescaling of the o200k column — two effects pull in opposite directions, and the [per-server pages](../docs/servers/) break both out. See [Claude divergence](../docs/METHODOLOGY.md#claude-divergence).

The **mcp-tokens** column is the other CLI's count of the same server — `sd2k/mcp-tokens` `v0.2.5` (2026-09-05, method `cli-cross-check/v1`), invoked with `--model gpt-4o` so both columns count o200k tokens. Its structs model the three request fields (name/description/input\_schema), so its number sits below the tokens column wherever a server ships metadata those fields do not carry — that gap is each server's field-selection share, published on its page, not a disagreement of counters. The parenthesized percentage is the disagreement of counters: the CLI's count against ours of the same three-field projection, −0.8% to +1.4% across the 83 rows where both tools saw the same tool set. A row prints only while the comparison is between like and like: the same tool names on both sides, and our capture unchanged since the run. See [CLI cross-check](../docs/METHODOLOGY.md#cli-cross-check).
...
| 23 | [postgres-mcp](../docs/servers/postgres-mcp.md) | 8,632 | 39 | 2,381 | 1,178 (+0.0%) | 9 | explain_query (1,147) | measured | community |
| 24 | [ssh-manager](../docs/servers/ssh-manager.md) | 8,446 | 143 | — | 8,162 (+0.2%) | 37 | ssh_sync (477) | measured | community |
| 25 | [serena](../docs/servers/serena.md) | 8,204 | 138 | 11,494 | 6,528 (−0.3%) | 29 | find_symbol (883) | measured | community |
| 26 | [mongodb](../docs/servers/mongodb.md) | 7,926 | 103 | 8,765 | 4,519 (+0.4%) | 27 | explain (813) | measured | vendor-official |
| 27 | [blender](../docs/servers/blender.md) | 6,928 | 169 | — | 6,162 (+0.0%) | 28 | download_polypizza_model (490) | measured | community |
| 28 | [shopify-dev](../docs/servers/shopify-dev.md) | 6,841 | 26 | — | 6,804 (+0.2%) | 6 | learn_shopify_api (2,847) | measured | vendor-official |
| 29 | [bitbucket-mcp](../docs/servers/bitbucket-mcp.md) | 6,156 | 230 | — | 6,156 (+0.0%) | 47 | listPipelineRuns (258) | measured | community |
| 30 | [agentphone](../docs/servers/agentphone.md) | 6,134 | 100 | — | 5,613 (+0.6%) | 28 | create_agent (763) | measured | community |
| 31 | [sentry](../docs/servers/sentry.md) | 6,086 | 40 | — | 5,432 (−0.2%) | 9 | update_issue (1,248) | measured | vendor-official |
| 32 | [pinecone](../docs/servers/pinecone.md) | 5,903 | 294 | 9,184 | 5,680 (+0.0%) | 9 | search-records (1,179) | measured | vendor-official |
| 33 | [chrome-devtools](../docs/servers/chrome-devtools.md) | 5,717 | 98 | — | 5,080 (−0.4%) | 29 | emulate (418) | measured | vendor-official |
| 34 | [kubernetes](../docs/servers/kubernetes.md) | 5,268 | 95 | 9,165 | 5,089 (+0.0%) | 23 | kubectl_create (945) | measured | community |
| 35 | [codebase-memory-mcp](../docs/servers/codebase-memory-mcp.md) | 5,258 | 205 | — | 4,776 (+0.0%) | 15 | search_graph (905) | measured | community |
| 36 | [clinicaltrialsgov](../docs/servers/clinicaltrialsgov.md) | 5,134 | 54 | — | 2,874 (−0.2%) | 7 | clinicaltrials_search_studies (1,257) | measured | community |
| 37 | [aws-documentation](../docs/servers/aws-documentation.md) | 5,045 | 425 | — | 3,380 (+0.0%) | 5 | search_documentation (1,956) | measured | vendor-official |
| 38 | [supabase](../docs/servers/supabase.md) | 5,007 | 342 | — | 4,061 (−0.0%) | 29 | query_logs (794) | measured | vendor-official |
| 39 | [huggingface](../docs/servers/huggingface.md) | 4,724 | 378 | — | 1,611 (+0.4%) | 4 | hf_fs (1,957) | measured | vendor-official |
| 40 | [excel](../docs/servers/excel.md) | 4,266 | 106 | — | 3,080 (+0.0%) | 25 | format_range (472) | measured | community |
| 41 | [airtable](../docs/servers/airtable.md) | 4,186 | 50 | — | 2,533 (+0.1%) | 16 | list_records (395) | measured | community |
| 42 | [playwright](../docs/servers/playwright.md) | 4,024 | 91 | — | 3,409 (+0.2%) | 24 | browser_take_screenshot (329) | measured | vendor-official |
| 43 | [arxiv](../docs/servers/arxiv.md) | 3,960 | 84 | — | 3,696 (−0.1%) | 19 | search_papers (516) | measured | community |
| 44 | [github-legacy](../docs/servers/github-legacy.md) | 3,548 | 103 | — | 3,564 (+0.5%) | 26 | create_pull_request_review (360) | measured | official-reference |
| 45 | [playwright-community](../docs/servers/playwright-community.md) | 2,920 | 158 | — | 2,925 (+0.2%) | 33 | playwright_get_visible_html (228) | measured | community |
| 46 | [chroma](../docs/servers/chroma.md) | 2,837 | 71 | — | 2,837 (+0.0%) | 13 | chroma_get_documents (610) | measured | vendor-official |
| 47 | [netlify](../docs/servers/netlify.md) | 2,831 | 61 | — | 2,707 (+1.1%) | 9 | netlify-project-services-updater (896) | measured | vendor-official |
| 48 | [filesystem](../docs/servers/filesystem.md) | 2,823 | 51 | — | 1,667 (+0.1%) | 14 | read_media_file (290) | measured | official-reference |
| 49 | [pulumi](../docs/servers/pulumi.md) | 2,768 | 73 | — | 2,650 (−0.4%) | 12 | pulumi-resource-search (1,011) | measured | vendor-official |
| 50 | [n8n-mcp](../docs/servers/n8n-mcp.md) | 2,636 | 24 | — | 2,031 (+0.4%) | 7 | search_templates (628) | measured | community |
| 51 | [memory](../docs/servers/memory.md) | 2,378 | 34 | — | 906 (+0.6%) | 9 | search_nodes (323) | measured | official-reference |
| 52 | [obsidian](../docs/servers/obsidian.md) | 2,062 | 92 | — | 2,064 (+0.1%) | 15 | obsidian_complex_search (492) | measured | community |
| 53 | [terraform](../docs/servers/terraform.md) | 2,061 | 963 | — | 1,718 (+0.0%) | 9 | search_providers (484) | measured | vendor-official |
| 54 | [everything](../docs/servers/everything.md) | 1,708 | 374 | — | 1,083 (+0.1%) | 13 | gzip-file-as-resource (247) | measured | official-reference |
| 55 | [tavily](../docs/servers/tavily.md) | 1,653 | 28 | — | 1,665 (+0.7%) | 5 | tavily_search (615) | measured | vendor-official |
| 56 | [searxng](../docs/servers/searxng.md) | 1,537 | 27 | — | 1,490 (+0.7%) | 4 | searxng_web_search (825) | measured | community |
| 57 | [git](../docs/servers/git.md) | 1,455 | 43 | — | 1,119 (+0.0%) | 12 | git_log (289) | measured | official-reference |
| 58 | [pandoc](../docs/servers/pandoc.md) | 1,425 | 5 | — | 1,426 (+0.1%) | 1 | convert-contents (1,423) | measured | community |
| 59 | [context7](../docs/servers/context7.md) | 1,052 | 135 | — | 983 (−0.2%) | 2 | resolve-library-id (643) | measured | vendor-official |
| 60 | [sequential-thinking](../docs/servers/sequential-thinking.md) | 1,003 | 5 | — | 866 (+0.1%) | 1 | sequentialthinking (1,001) | measured | official-reference |
| 61 | [bright-data](../docs/servers/bright-data.md) | 978 | 20 | — | 880 (+0.1%) | 5 | discover (347) | measured | vendor-official |
| 62 | [microsoft-learn](../docs/servers/microsoft-learn.md) | 972 | 307 | — | 726 (+0.0%) | 3 | microsoft_code_sample_search (396) | measured | vendor-official |
| 63 | [figma-context](../docs/servers/figma-context.md) | 946 | 11 | — | 898 (+0.0%) | 2 | download_figma_images (646) | measured | community |
| 64 | [duckduckgo](../docs/servers/duckduckgo.md) | 724 | 6 | — | 661 (+0.0%) | 2 | fetch_content (387) | measured | community |
| 65 | [slack-legacy](../docs/servers/slack-legacy.md) | 681 | 47 | — | 681 (+0.0%) | 8 | slack_reply_to_thread (124) | measured | official-reference |
| 66 | [clickhouse](../docs/servers/clickhouse.md) | 632 | 72 | — | 494 (−0.2%) | 3 | list_tables (353) | measured | vendor-official |
| 67 | [emailmd](../docs/servers/emailmd.md) | 585 | 377 | — | 546 (+0.7%) | 3 | render (227) | measured | community |
| 68 | [google-maps](../docs/servers/google-maps.md) | 549 | 30 | — | 550 (+0.2%) | 7 | maps_distance_matrix (124) | measured | official-reference |
| 69 | [puppeteer](../docs/servers/puppeteer.md) | 540 | 39 | — | 538 (−0.4%) | 7 | puppeteer_screenshot (142) | measured | official-reference |
| 70 | [neo4j-cypher](../docs/servers/neo4j-cypher.md) | 523 | 26 | — | 354 (+0.0%) | 3 | get_neo4j_schema (238) | measured | vendor-official |
| 71 | [exa](../docs/servers/exa.md) | 486 | 11 | — | 414 (+0.0%) | 2 | web_search_exa (289) | measured | vendor-official |
| 72 | [airbnb](../docs/servers/airbnb.md) | 486 | 10 | — | 486 (+0.0%) | 2 | airbnb_search (319) | measured | community |
| 73 | [cloudflare-docs](../docs/servers/cloudflare-docs.md) | 422 | 15 | — | 252 (+0.0%) | 2 | search_cloudflare_documentation (351) | measured | vendor-official |
| 74 | [mysql](../docs/servers/mysql.md) | 393 | 12 | — | 332 (−0.6%) | 3 | get_table_sample (139) | measured | community |
| 75 | [elasticsearch](../docs/servers/elasticsearch.md) | 374 | 14 | — | — | 4 | search (159) | measured | vendor-official |
| 76 | [browserbase](../docs/servers/browserbase.md) | 364 | 13 | — | 310 (+0.0%) | 6 | act (69) | measured | vendor-official |
| 77 | [deepwiki](../docs/servers/deepwiki.md) | 359 | 580 | — | 234 (+0.4%) | 3 | ask_question (148) | measured | vendor-official |
| 78 | [gitlab](../docs/servers/gitlab.md) | 336 | 33 | — | 336 (+0.0%) | 9 | get_file_contents (41) | measured | official-reference |
| 79 | [brave-search-legacy](../docs/servers/brave-search-legacy.md) | 319 | 11 | — | 320 (+0.3%) | 2 | brave_web_search (161) | measured | official-reference |
| 80 | [time](../docs/servers/time.md) | 293 | 8 | — | 237 (−0.8%) | 2 | convert_time (186) | measured | official-reference |
| 81 | [sqlite](../docs/servers/sqlite.md) | 268 | 20 | — | 268 (+0.0%) | 6 | write_query (50) | measured | official-reference |
| 82 | [fetch](../docs/servers/fetch.md) | 238 | 3 | — | 238 (+0.0%) | 1 | fetch (236) | measured | official-reference |
| 83 | [qdrant](../docs/servers/qdrant.md) | 188 | 11 | — | 188 (+0.0%) | 2 | qdrant-store (101) | measured | vendor-official |
| 84 | [perplexity](../docs/servers/perplexity.md) | 133 | 7 | — | 134 (+0.8%) | 1 | perplexity_ask (131) | measured | vendor-official |
| 85 | [markitdown](../docs/servers/markitdown.md) | 64 | 6 | — | 64 (+0.0%) | 1 | convert_to_markdown (62) | measured | vendor-official |
| 86 | [postgres](../docs/servers/postgres.md) | 32 | 3 | — | 32 (+0.0%) | 1 | query (30) | measured | official-reference |
