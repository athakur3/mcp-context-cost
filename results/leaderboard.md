...
The **claude** column is the same tools measured through Anthropic's `count_tokens` on `claude-opus-5` (2026-08-24, method `tools-delta/v1`): the tokens the server's tools add to a request, measured for the top 18. It is not a rescaling of the o200k column — two effects pull in opposite directions, and the [per-server pages](../docs/servers/) break both out. See [Claude divergence](../docs/METHODOLOGY.md#claude-divergence).
...
| 44 | [bright-data](../docs/servers/bright-data.md) | 978 | 20 | — | 5 | discover (347) | measured | vendor-official |
...
| 53 | [exa](../docs/servers/exa.md) | 486 | 11 | — | 2 | web_search_exa (289) | measured | vendor-official |
| 54 | [airbnb](../docs/servers/airbnb.md) | 486 | 10 | — | 2 | airbnb_search (319) | measured | community |
| 55 | [cloudflare-docs](../docs/servers/cloudflare-docs.md) | 422 | 15 | — | 2 | search_cloudflare_documentation (351) | measured | vendor-official |
| 56 | [mysql](../docs/servers/mysql.md) | 393 | 12 | — | 3 | get_table_sample (139) | measured | community |
| 57 | [elasticsearch](../docs/servers/elasticsearch.md) | 374 | 14 | — | 4 | search (159) | measured | vendor-official |
| 58 | [browserbase](../docs/servers/browserbase.md) | 364 | 13 | — | 6 | act (69) | measured | vendor-official |
| 59 | [deepwiki](../docs/servers/deepwiki.md) | 359 | 521 | — | 3 | ask_question (148) | measured | vendor-official |
| 60 | [gitlab](../docs/servers/gitlab.md) | 336 | 33 | — | 9 | get_file_contents (41) | measured | official-reference |
| 61 | [brave-search-legacy](../docs/servers/brave-search-legacy.md) | 319 | 11 | — | 2 | brave_web_search (161) | measured | official-reference |
| 62 | [time](../docs/servers/time.md) | 293 | 8 | — | 2 | convert_time (186) | measured | official-reference |
| 63 | [sqlite](../docs/servers/sqlite.md) | 268 | 20 | — | 6 | write_query (50) | measured | official-reference |
| 64 | [fetch](../docs/servers/fetch.md) | 238 | 3 | — | 1 | fetch (236) | measured | official-reference |
| 65 | [qdrant](../docs/servers/qdrant.md) | 188 | 11 | — | 2 | qdrant-store (101) | measured | vendor-official |
| 66 | [perplexity](../docs/servers/perplexity.md) | 133 | 7 | — | 1 | perplexity_ask (131) | measured | vendor-official |
| 67 | [markitdown](../docs/servers/markitdown.md) | 64 | 6 | — | 1 | convert_to_markdown (62) | measured | vendor-official |
| 68 | [postgres](../docs/servers/postgres.md) | 32 | 3 | — | 1 | query (30) | measured | official-reference |

## Not measured (and why)

| server | status | note |
|---|---|---|
| sequential-thinking | startup-failure | reproduced with the shared package cache bypassed; server exited (code 125); stderr tail: Unable to find image 'public.ecr.aws/docker/library/node:22-slim' loca |
