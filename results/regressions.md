...
Every server with a measurement on record is in exactly one of the three sections below: **18 moved**, **64 held the same cost across every comparable measurement**, and **5 have no second comparable measurement yet** — 18 + 64 + 5 = 87.

**13 servers moved upward and 5 moved down**, a net +4,587 tokens across the measured set. 6 movements clear both thresholds for being called out (at least 5% *and* at least 25 tokens — relative alone would headline a fifth of a cheap server, absolute alone would headline drift on an expensive one). Everything comparable is listed either way.
...
| [huggingface](../docs/servers/huggingface.md) | 2026-08-19 → 2026-09-04, held to 2026-09-05 | — | 4,691 → 4,724 | +33 (+0.7%) | — | same tools, rewritten |
| [aws-documentation](../docs/servers/aws-documentation.md) | 2026-08-19 → 2026-09-04, held to 2026-09-05 | — | 5,074 → 5,045 | −29 (−0.6%) | — | same tools, rewritten |
| [airtable](../docs/servers/airtable.md) | 2026-08-19 → 2026-09-04, held to 2026-09-05 | — | 4,207 → 4,186 | −21 (−0.5%) | — | same tools, rewritten |
| [github](../docs/servers/github.md) | 2026-08-18 → 2026-09-03, held to 2026-09-04 | — | 54,422 → 54,622 | +200 (+0.4%) | — | same tools, rewritten |
| [comfyui-mcp](../docs/servers/comfyui-mcp.md) | 2026-09-04 → 2026-09-05 | `0.52.189` → `0.52.199` | 50,640 → 50,776 | +136 (+0.3%) | — | same tools, rewritten |
| [apify](../docs/servers/apify.md) | 2026-08-19 → 2026-09-04 | — | 10,426 → 10,452 | +26 (+0.2%) | — | same tools, rewritten |
| [brave-search](../docs/servers/brave-search.md) | 2026-08-19 → 2026-09-04, held to 2026-09-05 | — | 25,456 → 25,487 | +31 (+0.1%) | — | same tools, rewritten |
| [supabase](../docs/servers/supabase.md) | 2026-08-18 → 2026-09-04 | — | 5,013 → 5,007 | −6 (−0.1%) | — | same tools, rewritten |
| [desktop-commander](../docs/servers/desktop-commander.md) | 2026-09-04 → 2026-09-05 | still `0.2.48` | 11,834 → 11,837 | +3 (+0.0%) | — | same tools, rewritten |

Rows marked **·** clear both thresholds.

The **release** column is what the two servers reported at `initialize`, on the two days either side of the movement. `—` means at least one of those rows does not record a version: either the server reports none, or the row was written before `history.csv` carried the column, and neither is something to fill in with a guess. 2 of 18 movements can name both sides today; the rest fill in as the rotation re-measures them.
...
| [hubspot](../docs/servers/hubspot.md) | 2026-08-16 → 2026-09-05 | 9,158 | 21 | 4 |
| [mongodb](../docs/servers/mongodb.md) | 2026-08-16 → 2026-09-04 | 7,926 | 27 | 5 |
| [pinecone](../docs/servers/pinecone.md) | 2026-08-16 → 2026-09-05 | 5,903 | 9 | 4 |
| [kubernetes](../docs/servers/kubernetes.md) | 2026-08-16 → 2026-09-04 | 5,268 | 23 | 5 |
| [excel](../docs/servers/excel.md) | 2026-08-16 → 2026-09-05 | 4,266 | 25 | 4 |
| [playwright](../docs/servers/playwright.md) | 2026-08-16 → 2026-09-05 | 4,024 | 24 | 4 |
...
| [chroma](../docs/servers/chroma.md) | 2026-08-16 → 2026-09-05 | 2,837 | 13 | 4 |
...
| [pandoc](../docs/servers/pandoc.md) | 2026-08-16 → 2026-09-05 | 1,425 | 1 | 4 |
...
| [slack-legacy](../docs/servers/slack-legacy.md) | 2026-08-16 → 2026-09-05 | 681 | 8 | 5 |
...
| [mysql](../docs/servers/mysql.md) | 2026-08-16 → 2026-09-05 | 393 | 3 | 4 |
| [browserbase](../docs/servers/browserbase.md) | 2026-08-16 → 2026-09-05 | 364 | 6 | 4 |
...
| [brave-search-legacy](../docs/servers/brave-search-legacy.md) | 2026-08-16 → 2026-09-05 | 319 | 2 | 4 |
| [qdrant](../docs/servers/qdrant.md) | 2026-08-16 → 2026-09-04 | 188 | 2 | 5 |
| [perplexity](../docs/servers/perplexity.md) | 2026-08-16 → 2026-09-05 | 133 | 1 | 4 |
| [markitdown](../docs/servers/markitdown.md) | 2026-08-16 → 2026-09-05 | 64 | 1 | 5 |
...
| [xcodebuildmcp](../docs/servers/xcodebuildmcp.md) | 2026-08-18 → 2026-09-05 | 26,594 | 24 | 4 |
| [postgres-mcp](../docs/servers/postgres-mcp.md) | 2026-08-18 → 2026-09-04 | 8,632 | 9 | 4 |
| [git](../docs/servers/git.md) | 2026-08-18 → 2026-09-05 | 1,455 | 12 | 3 |
| [neo4j-cypher](../docs/servers/neo4j-cypher.md) | 2026-08-18 → 2026-09-05 | 523 | 3 | 4 |
| [elasticsearch](../docs/servers/elasticsearch.md) | 2026-08-18 → 2026-09-05 | 374 | 4 | 4 |
...
| [bitbucket-mcp](../docs/servers/bitbucket-mcp.md) | 2026-09-03 → 2026-09-05 | 6,156 | 47 | 3 |
...
| [codebase-memory-mcp](../docs/servers/codebase-memory-mcp.md) | 2026-09-03 → 2026-09-05 | 5,258 | 15 | 3 |
...
| [google-surf](../docs/servers/google-surf.md) | 2026-09-04 → 2026-09-05 | 10,948 | 7 | 2 |
